...
ActiveRecord::Schema.define(version: 20160118093219) do
  ...
  create_table "group_maintainers", force: true do |t|
    t.integer  "group_id"
    t.integer  "user_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "notices_photos", id: false, force: true do |t|
